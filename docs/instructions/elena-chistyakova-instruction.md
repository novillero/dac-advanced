...
6. Для получения моноширинного шрифта (позволяет другим пользователям копировать написанный текст в буфер оSбмена, всего лишь кликнув по нему) выберите пункт "Formatting/Monospace" или сочетание клавиш "Ctrl+Shift+M":
