...
Опции форматирования также можно вызвать горячими клавишами.
...
7. Для получения скрытого текста (спойлера) выберите пункт "Formatting/Spoiler" или сочетание клавиш "Ctrl+Shift+P":

    ??? note "Cпойлер"
        Скрытый шрифт в Telegram

8. Для получения ссылки выберите пункт "Formatting/Create link" или сочетание клавиш "Ctrl+K". В открывшемся окне впишите адрес нужной страницы в поле "URL" и нажмите кнопку **Create**:
    ...
    [Ссылка в Telegram](https://ru.wikipedia.org/wiki/Telegram)
